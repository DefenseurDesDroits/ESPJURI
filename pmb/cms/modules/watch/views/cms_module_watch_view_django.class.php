...
// +-------------------------------------------------+
// $Id: cms_module_watch_view_django.class.php,v 1.1.4.1 2016-02-12 10:13:09 jpermanne Exp $
...
{% endif %}
<h3>{{watch.title}}</h3>
<a href='{{watch.rss_link}}' title='RSS' target='_blank'><img src='./images/rss.png' alt='RSS'></a>
