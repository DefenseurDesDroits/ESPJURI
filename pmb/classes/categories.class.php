...
// +-------------------------------------------------+
// $Id: categories.class.php,v 1.36.2.3 2017-01-10 08:31:39 jpermanne Exp $
...
class categories{
	...
	//Constructeur	 
	function categories($num_noeud, $langue, $for_indexation=false) {
	...
	static function getlibelle($num_noeud=0, $langue=""){
		global $dbh;
		$lib="";
		$thes = thesaurus::getByEltId($num_noeud);
