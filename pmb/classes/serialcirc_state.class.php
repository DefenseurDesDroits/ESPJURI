...
// +-------------------------------------------------+
// $Id: serialcirc_state.class.php,v 1.1.2.5 2017-02-22 11:14:13 jpermanne Exp $
...
class serialcirc_state {
	...
	public function get_list() {
		...
		$url = './edit.php?categ=serials&sub=circ_state&serialcirc_state_location_filter='.$this->location_id.'&serialcirc_state_caddie_filter='.$this->caddie_id.'&serialcirc_state_perio_filter_id='.$this->perio_id;
	...
	public function export_list_tableauhtml() {
		...
		$content.= "<table>" ;
		$content.= "<tr>
			<th width='20%'>".$msg["1150"]."</th>
			<th width='16%'>".$msg["serialcirc_circ_list_bull_circulation_abonnement"]."</th>
			<th width='16%'>".$msg["379"]."</th>
			<th width='16%'>".$msg["adresse_empr"]."</th>
			<th width='16%'>".$msg["ville_empr"]."</th>
			<th width='16%'>".$msg["serial_circ_state_end_location"]."</th>
		</tr>";
