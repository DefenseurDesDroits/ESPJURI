...
// +-------------------------------------------------+
// $Id: mono_display.class.php,v 1.255.2.17 2017-05-15 12:50:55 jpermanne Exp $
			...
			while($expl = pmb_mysql_fetch_object($result)) {
				...
				if ($this->print_mode)
					...
					if(SESSrights & CATALOGAGE_AUTH){
						...
						$cart_over_out = "onMouseOver=\"show_div_access_carts(event,".$expl->expl_id.",'EXPL');\" onMouseOut=\"set_flag_info_div(false);\"";
