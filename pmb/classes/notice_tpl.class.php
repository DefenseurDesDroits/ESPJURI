...
// +-------------------------------------------------+
// $Id: notice_tpl.class.php,v 1.5.4.2 2017-03-16 12:13:26 jpermanne Exp $
...
class notice_tpl {
	...
	// ----------------------------------------------------------------------------------
	function get_is_truncated_form() {
	...
	// ---------------------------------------------------------------------
	function get_form_typenotice_all_loc() {
	...
	// ----------------------------------------------------------------------
	function get_form_typenotice_all($id_location, $tab_typenotice) {
		global $charset;
