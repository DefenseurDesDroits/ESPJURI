...
// +-------------------------------------------------+
// $Id: harvest.class.php,v 1.4.4.1 2017-02-24 10:27:30 dgoron Exp $
    	...
    	while ($source=pmb_mysql_fetch_object($resultat)) {
    		$r.="
    			<tr>
    				...
    				<td>".
    				$this->create_list_fields($facette->fields_sort(),$source->source_id,$this->info['search_field'][$source->source_id]['field'], $this->info['search_field'][$source->source_id]['ss_field'])."
    				</td>
    			</tr>";    			
    	}
