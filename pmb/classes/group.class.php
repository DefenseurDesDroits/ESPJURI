...
// +-------------------------------------------------+
// $Id: group.class.php,v 1.14.4.3 2017-02-01 15:08:37 jpermanne Exp $
...
class group {
	...
	static function gen_combo_box_grp ( $selected=false, $multiple=0, $afficher_aucun=1, $afficher_premier=1, $on_change="" ) {
