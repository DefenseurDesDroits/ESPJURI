...
// +-------------------------------------------------+
// $Id: serials.class.php,v 1.168.2.15 2017-02-07 14:39:34 jpermanne Exp $
...
class bulletinage extends serial {
	...
	var $b_num_notice_usage = 0; // droit d'usage
...
class analysis extends bulletinage {
	...
	var $analysis_num_notice_usage = 0; // droit d'usage
