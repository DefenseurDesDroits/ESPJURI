...
// +-------------------------------------------------+
// $Id: cms_editorial_parametres_perso.class.php,v 1.20.2.5 2017-04-21 09:27:15 ngantier Exp $
...
class cms_editorial_parametres_perso extends parametres_perso {
	...
	public function get_out_values($id) {
		...
		if ((!$this->no_special_fields)&&($id)) {
			$this->values = array() ;
			$requete="select ".$this->prefix."_custom_champ,".$this->prefix."_custom_origine,".$this->prefix."_custom_small_text, ".$this->prefix."_custom_text, ".$this->prefix."_custom_integer, ".$this->prefix."_custom_date, ".$this->prefix."_custom_float from ".$this->prefix."_custom_values join ".$this->prefix."_custom on idchamp=".$this->prefix."_custom_champ and num_type = ".$this->num_type."  where ".$this->prefix."_custom_origine='".($id*1)."'";
			$resultat=pmb_mysql_query($requete);
	...
	public function delete_values($id,$type="") {
		...
		$requete = "DELETE FROM ".$this->prefix."_custom_values where ".$this->prefix."_custom_champ in (".$idchamp.") and ".$this->prefix."_custom_origine='".($id*1)."'";
	...
	public function rec_fields_perso($id,$type="") {
		...
		if ($result && pmb_mysql_num_rows($result)) {
			$requete="delete ".$this->prefix."_custom_values from ".$this->prefix."_custom_values
 					...
 					where ".$this->prefix."_custom_origine='".($id*1)."'";
			pmb_mysql_query($requete);
		}
		if($type){
		...
		while (list($key,$val)=each($this->t_fields)) {
			...
			for ($i=0; $i<count($value); $i++) {
				if ($value[$i]!=="") {
					$requete="insert into ".$this->prefix."_custom_values (".$this->prefix."_custom_champ,".$this->prefix."_custom_origine,".$this->prefix."_custom_".$val["DATATYPE"].") values($key,'".($id*1)."','".$value[$i]."')";
					pmb_mysql_query($requete);
				}
			}
		}
	...
	public function duplicate_fields_perso($id,$duplicate_from_id, $type = "") {
		...
		if($type){
			...
			if($generic_type){
				$generic = new cms_editorial_parametres_perso($generic_type);
				$requete="select ".$generic->prefix."_custom_champ,".$generic->prefix."_custom_origine,".$generic->prefix."_custom_small_text, ".$generic->prefix."_custom_text, ".$generic->prefix."_custom_integer, ".$generic->prefix."_custom_date, ".$generic->prefix."_custom_float from ".$generic->prefix."_custom_values join ".$generic->prefix."_custom on idchamp=".$generic->prefix."_custom_champ and num_type = ".$generic_type." where ".$generic->prefix."_custom_origine='".($duplicate_from_id*1)."'";
				...
				while ($r=pmb_mysql_fetch_array($resultat)) {
					$requete="insert into ".$generic->prefix."_custom_values (".$generic->prefix."_custom_champ,".$generic->prefix."_custom_origine,".$generic->prefix."_custom_small_text, ".$generic->prefix."_custom_text, ".$generic->prefix."_custom_integer, ".$generic->prefix."_custom_date, ".$generic->prefix."_custom_float)
						values(".$r[$generic->prefix."_custom_champ"].",'".($id*1)."','".$r[$generic->prefix."_custom_small_text"]."','".$r[$generic->prefix."_custom_text"]."','".$r[$generic->prefix."_custom_integer"]."','".$r[$generic->prefix."_custom_date"]."','".$r[$generic->prefix."_custom_float"]."')";
					pmb_mysql_query($requete,$dbh);
				}
			}
		}
		$requete="select ".$this->prefix."_custom_champ,".$this->prefix."_custom_origine,".$this->prefix."_custom_small_text, ".$this->prefix."_custom_text, ".$this->prefix."_custom_integer, ".$this->prefix."_custom_date, ".$this->prefix."_custom_float from ".$this->prefix."_custom_values join ".$this->prefix."_custom on idchamp=".$this->prefix."_custom_champ and num_type = ".$this->num_type." where ".$this->prefix."_custom_origine='".($duplicate_from_id*1)."'";
		$resultat=pmb_mysql_query($requete,$dbh);
		while ($r=pmb_mysql_fetch_array($resultat)) {
			$requete="insert into ".$this->prefix."_custom_values (".$this->prefix."_custom_champ,".$this->prefix."_custom_origine,".$this->prefix."_custom_small_text, ".$this->prefix."_custom_text, ".$this->prefix."_custom_integer, ".$this->prefix."_custom_date, ".$this->prefix."_custom_float)
				values(".$r[$this->prefix."_custom_champ"].",'".($id*1)."','".$r[$this->prefix."_custom_small_text"]."','".$r[$this->prefix."_custom_text"]."','".$r[$this->prefix."_custom_integer"]."','".$r[$this->prefix."_custom_date"]."','".$r[$this->prefix."_custom_float"]."')";
			pmb_mysql_query($requete,$dbh);
		}
	}
