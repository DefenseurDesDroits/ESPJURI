...
// +-------------------------------------------------+
// $Id: calendar.class.php,v 1.15.4.2 2017-06-08 13:25:22 jpermanne Exp $
...
class calendar {
    ...
    static function get_open_days($dd,$md,$yd,$df,$mf,$yf,$loc_calendar = 0) {
    ...
    static function add_days($dd,$md,$yd,$days,$loc_calendar = 0) {
    	global $pmb_utiliser_calendrier;
    	global $deflt2docs_location;
