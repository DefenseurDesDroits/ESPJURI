...
// +-------------------------------------------------+
// $Id: caddie.class.php,v 1.48.2.6 2017-04-14 14:13:19 jpermanne Exp $
...
class caddie {
	...
	public $liaisons = array("etageres" => array(),"bannettes" => array(),"rss_flux" => array(),"connectors" => array()); // Liaisons associées à un panier
	...
	// ---------------------------------------------------------------
	public function caddie($caddie_id=0) {
		if($caddie_id) {
	...
	public function save_cart() {
		global $dbh;
		$requete = "update caddie set name='".addslashes($this->name)."', comment='".addslashes($this->comment)."', autorisations='".$this->autorisations."', caddie_classement='".addslashes($this->classementGen)."', acces_rapide='".$this->acces_rapide."' where idcaddie='".$this->idcaddie."'";
		$result = @pmb_mysql_query($requete, $dbh);
	}
