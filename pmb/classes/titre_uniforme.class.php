...
// +-------------------------------------------------+
// $Id: titre_uniforme.class.php,v 1.45.2.3 2016-03-30 10:15:38 mbertin Exp $
...
class titre_uniforme {
	...
	var $tu_form;					// catégorie à laquelle appartient l'oeuvre (roman, pièce de théatre, poeme, ...)
