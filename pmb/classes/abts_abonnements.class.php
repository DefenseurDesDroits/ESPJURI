...
// +-------------------------------------------------+
// $Id: abts_abonnements.class.php,v 1.41.2.6 2017-03-03 15:20:57 jpermanne Exp $
...
ENDOFTEXT;
	...
	function proceed() {
		...
		global $dbh,$abt_id;
		global $cote,$typdoc_id,$exemp_auto,$location_id,$lender_id,$statut_id,$codestat_id, $prix,$type_antivol,$abt_numeric;
		global $deflt_docs_section;
