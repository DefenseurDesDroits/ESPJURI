...
// +-------------------------------------------------+
// $Id: demandes.class.php,v 1.39.4.6 2016-07-19 14:21:45 jpermanne Exp $
			...
			while(($doc = pmb_mysql_fetch_object($res))){
				...
				<div class='row'>
					<div class='colonne3'>
						...
						<a href=\"$base_path/explnum_doc.php?explnumdoc_id=".$doc->id."'\" target=\"_blank\"><img src='$base_path/images/globe_orange.png' /></a>
					</div>
					<div class='colonne3'>	
