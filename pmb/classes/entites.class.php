...
// +-------------------------------------------------+
// $Id: entites.class.php,v 1.45.2.2 2017-02-02 08:36:52 jpermanne Exp $
...
class entites{
	...
	static function listActes($id_bibli, $type_acte, $statut='-1', $debut=0, $nb_per_page=0, $aq=0, $user_input='', $tri='', $id_exercice=0) {
	...
	static function getNbActes($id_bibli, $type_acte, $statut='-1', $aq=0, $user_input='', $id_exercice=0) {
	...
	static function findRubriquesFinales($id_rubrique){
