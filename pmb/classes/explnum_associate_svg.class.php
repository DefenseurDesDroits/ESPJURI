...
// +-------------------------------------------------+
// $Id: explnum_associate_svg.class.php,v 1.5.4.1 2017-02-03 11:57:16 jpermanne Exp $
...
class explnum_associate_svg {
	...
	private function getJsEdit() {
		...
		function openPopUpCall(id) {
			openPopUp('./select.php?what=auteur&callback=update_associate_author&caller=explnum_associate_speaker_' + id + '&param1=aut' + id + '_id&param2=aut' + id + '&deb_rech='+".pmb_escape()."(document.getElementById('aut' + id).value), 'select_author0', 500, 400, -2, -2, 'scrollbars=yes, toolbar=no, dependent=yes, resizable=yes');
		}";
