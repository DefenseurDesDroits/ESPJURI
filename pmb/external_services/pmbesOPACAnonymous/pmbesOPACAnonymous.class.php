...
// +-------------------------------------------------+
// $Id: pmbesOPACAnonymous.class.php,v 1.18.10.1 2016-09-21 08:49:56 dgoron Exp $
...
class pmbesOPACAnonymous extends external_services_api_class{
	...
	function listFacets($searchId, $fields = array(), $filters = array()) {
		return $this->proxy_parent->pmbesSearch_listFacets($searchId, $fields, $filters);
	}
	
	function listRecordsFromFacets($searchId, $filters = array()) {
