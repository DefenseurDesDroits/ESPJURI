...
// +-------------------------------------------------+
// $Id: ajax_selector.php,v 1.59.4.7 2017-03-21 15:43:48 jpermanne Exp $
...
switch($completion):
	...
	case 'concepts':
		...
		break;
	case 'profession':
		$requete="select distinct empr_prof from empr where empr_prof like '".addslashes($start)."%' order by 1 limit 20";
		$origine = "SQL" ;
		break;
	default: 
