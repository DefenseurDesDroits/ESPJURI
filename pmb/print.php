...
// +--------------------------------------------------------------------------+
// $Id: print.php,v 1.42.2.3 2016-11-09 16:26:22 jpermanne Exp $
...
if (($action_print=="")&&($_SESSION["PRINT"])) {
	...
	switch($environement['output']) {
		...
		case 'email':
			...
			if ($res_envoi) {
				print "$pheader<br /><br /><center><h3>".sprintf($msg["print_emailsucceed"],$emaildest)."</h3><br /><a href=\"\" onClick=\"self.close(); return false;\">".$msg["print_emailclose"]."</a></center></body></html>" ;
			} else {
				print "$pheader<br /><br /><center><h3>".sprintf($msg["print_emailfailed"],$emaildest)."</h3><br /><a href=\"\" onClick=\"self.close(); return false;\">".$msg["print_emailclose"]."</a></center></body></html>" ;
			}
			break;	
		case 'printer':
