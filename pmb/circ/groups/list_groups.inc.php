...
// +-------------------------------------------------+
// $Id: list_groups.inc.php,v 1.19.2.1 2016-06-08 12:35:39 jpermanne Exp $
...
$filter_list = "<form class='form-$current_module' id='form-$current_module-list' name='form-$current_module-list' action='$PHP_SELF?categ=$categ&action=$action&group_location_id=$group_location_id&group_query=$group_query' method='post'>";
