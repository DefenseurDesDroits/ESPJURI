...
// +-------------------------------------------------+
// $Id: show_group.inc.php,v 1.21.4.1 2017-06-03 08:11:23 jpermanne Exp $
...
if (trim($myGroup->mail_resp)) {
	print pmb_bidi("&nbsp;<input type='button' name='mail_resp_liste_prets' class='bouton' value='".$msg["mail_resp_liste_prets"]."' onClick=\"if (confirm('".$msg["mail_resp_liste_prets_confirm_js"]."')) { openPopUp('./pdf.php?pdfdoc=mail_liste_pret_groupe&id_groupe=".$groupID."', 'print_PDF', 600, 500, -2, -2, '');} return(false) \" />");
}
print pmb_bidi("
			</h3>");
