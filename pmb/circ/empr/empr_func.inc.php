...
// +-------------------------------------------------+
// $Id: empr_func.inc.php,v 1.76.4.4 2017-03-07 10:23:06 jpermanne Exp $
...
function show_empr_form($form_action, $form_cancel, $link, $id, $cb,$duplicate_empr_from_id="") {
	...
	for ($i=0; $i<count($perso_["FIELDS"]); $i++) {
		$p=$perso_["FIELDS"][$i];
		$perso.="<div class='$class' id='g6_r0_f".$p["ID"]."' movable='yes' draggable='yes' dragtype='circcell' recept='yes' recepttype='circcell' highlight='circcell_highlight' downlight='circcell_downlight' title='".htmlentities($p['TITRE'],ENT_QUOTES,$charset)."' >";
