...
// +-------------------------------------------------+
// $Id: panier.inc.php,v 1.4.2.3 2016-05-28 13:58:44 jpermanne Exp $
...
switch ($action) {
	...
	case 'edit_cart':
		...
		$empr_cart_edit_form = str_replace('!!infos_creation!!', $myCart->get_info_creation(), $empr_cart_edit_form);
		...
		$empr_cart_edit_form = str_replace("!!acces_rapide!!",($myCart->acces_rapide?"checked='checked'":""),$empr_cart_edit_form);
