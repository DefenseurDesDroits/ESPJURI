...
// +-------------------------------------------------+
// $Id: retour_secouru.inc.php,v 1.28.2.1 2016-02-16 10:13:05 jpermanne Exp $
...
if (!$do) {
	...
	if ($line===false) { 
		...
		if ($error) {
			...
			print "<center><input type='button' value='".$msg['secouru_force_recup']."' onClick=\"document.location='./circ.php?categ=retour_secouru_int&file=".rawurlencode($file)."&do=1'\" class='bouton'>&nbsp;<input type='button' value='".$msg['76']."' onClick=\"document.location='./circ.php?categ=retour_secouru';\" class='bouton'></center>";
		} else {
