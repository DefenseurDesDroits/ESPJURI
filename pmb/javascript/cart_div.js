...
// +-------------------------------------------------+
// $Id: cart_div.js,v 1.1.2.2 2016-04-15 12:50:46 dgoron Exp $ */
...
function show_div_access_carts(event,id_object,type_object) {
	if (info_div_show==id_object) {
		return true;
	}
	set_flag_info_div(true);
	setTimeout(function(){ show_div_access_carts_suite(event,id_object,type_object); }, 1000);
}

function show_div_access_carts_suite(event,id_object,type_object) {
