...
// +-------------------------------------------------+
// $Id: export.class.php,v 1.73.4.5 2016-12-23 10:01:50 jpermanne Exp $
				...
				if($params["mere"]){
					...
					while(($notice_fille=pmb_mysql_fetch_object($resultat))) {						
						...
						while(($notice_mere=pmb_mysql_fetch_object($resultat_mere))) {
							...
							if($params["notice_mere"] && (array_search($notice_mere->notice_id,$this->notice_exporte)===false) && (array_search($notice_mere->notice_id,$this->notice_list)===false)){
				...
				if($params["fille"]){
					...
					while(($notice_mere=pmb_mysql_fetch_object($resultat))) {						
						...
						while(($notice_fille=pmb_mysql_fetch_object($resultat_fille))) {
							...
							if($params["notice_fille"] && (array_search($notice_fille->notice_id,$this->notice_exporte)===false) && (array_search($notice_fille->notice_id,$this->notice_list)===false)){
