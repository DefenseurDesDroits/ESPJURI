...
// +-------------------------------------------------+
// $Id: nav_collections.class.php,v 1.3.4.1 2017-02-24 10:43:23 jpermanne Exp $
...
class nav_collections {    
	...
	function get_form(){
		...
		if (count($liste_id)) {
			$tpl_liste_item_tableau .= "<input type='button' class='bouton_small' value='".$msg['tout_cocher_checkbox']."' onclick='check_checkbox(\"".implode("|",$liste_id)."\",1);' align='middle'>";
			$tpl_liste_item_tableau .= "<input type='button' class='bouton_small' value='".$msg['tout_decocher_checkbox']."' onclick='check_checkbox(\"".implode("|",$liste_id)."\",0);' align='middle'>";
		}
