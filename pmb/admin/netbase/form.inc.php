...
// +-------------------------------------------------+
// $Id: form.inc.php,v 1.35.2.1 2017-05-23 13:03:03 jpermanne Exp $
...
if (pmb_mysql_num_rows(mysql_query($rqt,$dbh))) {
	print "
	<div class='row'>
		<input type='checkbox' value='1073741824' name='delete_empr_passwords'>&nbsp;<label class='etiquette'>".htmlentities($msg["delete_empr_passwords"], ENT_QUOTES, $charset)."</label>
		</div>";
}
print "
	</div>
