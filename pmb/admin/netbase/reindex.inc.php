...
// +-------------------------------------------------+
// $Id: reindex.inc.php,v 1.32.4.1 2017-05-24 13:17:06 jpermanne Exp $
...
switch ($index_quoi) {
	...
	case 'TITRES_UNIFORMES':
		...
		print "<br /><br /><h2 align='center'>".htmlentities($msg["nettoyage_reindex_tu"], ENT_QUOTES, $charset)."</h2>";
		...
		if (pmb_mysql_num_rows($query)) {
			...
			print "<img src='../../images/jauge.png' width='$jauge_size' height='16'></td></tr></table>";
			print "<div align='center'>100%</div>";
			$v_state .= "<br /><img src=../../images/d.gif hspace=3>".htmlentities($msg["nettoyage_reindex_tu"], ENT_QUOTES, $charset)." $count ".htmlentities($msg["nettoyage_res_reindex_tu"], ENT_QUOTES, $charset);
			print "
				<form class='form-$current_module' name='current_state' action='./clean.php' method='post'>
				<input type='hidden' name='v_state' value=\"".urlencode($v_state)."\">
				<input type='hidden' name='spec' value=\"$spec\">
