...
// +-------------------------------------------------+
// $Id: main.inc.php,v 1.12.4.1 2016-10-05 13:00:43 jpermanne Exp $
...
switch ($sub) {
	...
	default:
		...
		if (trim($duplicate_form)) {
			$duplicate_form .= "&nbsp;<input type='button' class='bouton_small' value='".$msg['tout_cocher_checkbox']."' onclick='check_checkbox(\"".implode("|",$liste_input_loc_ids)."\",1);' align='middle'>
				<input type='button' class='bouton_small' value='".$msg['tout_decocher_checkbox']."' onclick='check_checkbox(\"".implode("|",$liste_input_loc_ids)."\",0);' align='middle'>";
		}
