...
// +-------------------------------------------------+
// $Id: users_func.inc.php,v 1.36.4.3 2016-04-28 09:10:25 jpermanne Exp $
...
function show_users($dbh) {
	...
	while(($row=pmb_mysql_fetch_object($res))) {
		...
		if($row->user_alert_serialcircmail)
			$dummy =str_replace('!!user_alert_serialcircmail!!', $msg['alert_subscribe_serialcirc_mail'].'<img src=./images/tick.gif align=top hspace=3>' , $dummy);
		else
