...
// +-------------------------------------------------+
// $Id: calendrier.inc.php,v 1.19.4.1 2017-05-31 09:31:04 jpermanne Exp $
...
function set_parent(f_caller, id_value, libelle_value)
{
	...
	if ($func_other_to_call != "") echo "window.opener.$func_other_to_call(f_caller,'".$param1."',id_value,'".$param2."',libelle_value,".$sub_param1.");";
