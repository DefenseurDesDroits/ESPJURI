...
// +-------------------------------------------------+
// $Id: expand_ajax.inc.php,v 1.3.6.1 2016-01-18 15:53:07 jpermanne Exp $
...
switch($param['function_to_call']) {
	case 'serial_display' :
		...
		if(SESSrights & CATALOGAGE_AUTH){
			$display->result="	<img src='./images/basket_small_20x20.gif' align='middle' alt='basket' title=\"${msg[400]}\" $cart_click $cart_over_out>$print_action !!serial_type!! !!ISBD!!";
		}else{
	...
	case 'mono_display' :
		...
		if(SESSrights & CATALOGAGE_AUTH){
			...
			$display->result="<div><img src='./images/basket_small_20x20.gif' align='middle' alt='basket' title=\"${msg[400]}\" $cart_click $cart_over_out>$print_action !!ISBD!!</div>";
		}else{
