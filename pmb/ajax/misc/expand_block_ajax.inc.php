...
// +-------------------------------------------------+
// $Id: expand_block_ajax.inc.php,v 1.4.2.1 2016-01-19 09:51:10 jpermanne Exp $
...
function read_notice_contenu($cmd) {
	...
	switch($param['function_to_call']) {
		...
		case 'mono_display' :
			...
			if(SESSrights & CATALOGAGE_AUTH){
				$display->result="	<img src='./images/basket_small_20x20.gif' align='middle' alt='basket' title=\"${msg[400]}\" $cart_click $cart_over_out>$print_action !!ISBD!!";
			}else{
