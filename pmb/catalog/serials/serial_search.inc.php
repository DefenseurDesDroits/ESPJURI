...
// +-------------------------------------------------+
// $Id: serial_search.inc.php,v 1.28.4.2 2017-06-08 06:29:50 jpermanne Exp $
...
$base_url = "./catalog.php?categ=serials&sub=search&user_query=".rawurlencode(stripslashes($user_query)).($filter_abo_actif?"&filter_abo_actif=1":"");
