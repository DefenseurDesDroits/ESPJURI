...
// +-------------------------------------------------+
// $Id: avis_ajax.inc.php,v 1.11.2.2 2016-04-22 09:42:39 jpermanne Exp $
...
function update_avis($id){
	...
	while(($loc = pmb_mysql_fetch_object($res))){
		...
		if (!$loc->valide) $display .=
				"<font color='#CC0000'><span >$note<b>".htmlentities($loc->sujet,ENT_QUOTES,$charset)."</b></span></font>";
		else $display .=
				"<font color='#00BB00'><span >$note<b>".htmlentities($loc->sujet,ENT_QUOTES,$charset)."</b></span></font>";
