...
// +-------------------------------------------------+
// $Id: isbd.inc.php,v 1.49.4.2 2016-01-19 10:19:14 jpermanne Exp $
...
if ($acces_l==0) {
	...
	$cart_click_isbd = "<img src='./images/basket_small_20x20.gif' align='middle' alt='basket' title=\"${msg[400]}\" $cart_click_isbd $cart_over_out>" ;
