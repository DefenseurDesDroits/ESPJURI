...
// +-------------------------------------------------+
// $Id: update_notice.inc.php,v 1.99.2.4 2017-02-16 12:31:35 jpermanne Exp $
...
if ($acces_m==0) {
	...
	if(($f_tit1)&&trim($f_tit1)&&(!$nberrors)) {
		...
		$titre_uniforme=notice::getAutomaticTu($id);//ATTENTION si on récpère le titre uniforme ici alors il est bien ajoué à la notice mais pas affiché
