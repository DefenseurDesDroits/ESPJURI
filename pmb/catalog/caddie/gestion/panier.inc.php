...
// +-------------------------------------------------+
// $Id: panier.inc.php,v 1.18.2.2 2016-05-28 13:58:44 jpermanne Exp $
...
switch ($action) {
	...
	case 'edit_cart':
		...
		$cart_edit_form = str_replace('!!infos_creation!!', $myCart->get_info_creation(), $cart_edit_form);
		...
		$cart_edit_form = str_replace("!!acces_rapide!!",($myCart->acces_rapide?"checked='checked'":""),$cart_edit_form);
