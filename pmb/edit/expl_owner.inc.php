...
// +-------------------------------------------------+
// $Id: expl_owner.inc.php,v 1.13.2.2 2017-02-22 11:14:10 jpermanne Exp $
...
switch($dest) {
	...
	default:
		...
		<input type='image' src='./images/tableur.gif' border='0' onClick=\"this.form.dest.value='TABLEAU';\" alt='".$msg['export_tableur']."' title='".$msg['export_tableur']."' /><font size='4'>&nbsp;&nbsp;|&nbsp;&nbsp;</font>
		<input type='image' src='./images/tableur_html.gif' border='0' onClick=\"this.form.dest.value='TABLEAUHTML';\" alt='".$msg['export_tableau_html']."' title='".$msg['export_tableau_html']."' />
		</form></p>";
		break;
	}
