...
// +-------------------------------------------------+
// $Id: expl_groupe.inc.php,v 1.39.2.1 2016-08-16 18:40:00 Alexandre Exp $
		...
		switch ($sub) {
			case "ppargroupe":
				...
				if ($mail_responsable) {
					...
					echo "</td><td align=center><a href=\"#\" ".$mail_click."><img src=\"./images/mail.png\" title=\"".$msg[mail_retard]."\" alt=\"".$msg[mail_retard]."\" border=\"0\"></a>";
				} else {
					echo "</td><td>&nbsp;";
				}
			break;
			...
			case "ppargroupe":
				if ($retard) {
					...
					if (($empr_mail)&&($biblio_email)) {
						echo "</td><td align=center><a href=\"#\" ".$mail_click."><img src=\"./images/mail.png\" title=\"".$msg[mail_retard]."\" alt=\"".$msg[mail_retard]."\" border=\"0\"></a></td>";
					} else {
						echo "</td><td>&nbsp;</td>";
					}
				} else {
