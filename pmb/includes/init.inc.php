...
// +-------------------------------------------------+
// $Id: init.inc.php,v 1.29.12.2 2017-04-12 07:47:59 ngantier Exp $
...
if (file_exists($include_path."/parameters_subst/rfid_per_localisations_subst.xml")){
	$parameter_subst = new parameters_subst($include_path."/parameters_subst/rfid_per_localisations_subst.xml", $deflt2docs_location);
} else {
