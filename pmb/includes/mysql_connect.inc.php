...
// +-------------------------------------------------+
// $Id: mysql_connect.inc.php,v 1.13.4.1 2016-08-25 08:47:31 jpermanne Exp $
...
function connection_mysql($er_connec=1, $my_bd='', $bd=1, $er_bd=1) {
	...
	pmb_mysql_query('SET SESSION SQL_MODE="NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION"',$my_connec);
	return $my_connec;
}
