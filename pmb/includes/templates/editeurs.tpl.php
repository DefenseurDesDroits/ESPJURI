...
// +-------------------------------------------------+
// $Id: editeurs.tpl.php,v 1.27.4.3 2016-06-21 08:45:05 jpermanne Exp $
...
<div id='el_0Parent' class='parent' >
	<h3>
    	<img src='./images/plus.gif' class='img_plus' align='bottom' name='imEx' id='el_0Img' title='$msg[categ_links]' border='0' onClick=\"expandBase('el_0', true); return false;\" />
    	".$msg['136']."
    </h3>
</div>
