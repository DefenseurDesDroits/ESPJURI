...
<script type='text/javascript'>
	...
	function load_subfields(id_ss_champs){
		...
		xhr_object.request('./ajax.php?module=admin&categ=opac&section=lst_facette',true,\"list_crit=\"+document.getElementById('list_crit').value+\"&sub_field=\"+id_ss_champs,'true',cback,0,0)
	}
...
<form class='form-$current_module' name='facette_form' method='post' action='./admin.php?categ=opac&sub=facette_search_opac&section=facette&action=save&id=!!id!!' onSubmit='return check_form_facette()'>
	<h3>!!libelle!!</h3>
	<div class='form-contenu'>
		...
		<div class='row'>
			<input id='label_facette' type='text' name='label_facette' value='!!label!!'/>
		</div>
		<div class='row'>
		...
		<div class='row'>
			...
			<label for='type_sort_nb_results'>".$msg['intit_gest_tri1']."</label>
			<input type='radio' id='type_sort_value' name='type_sort' value='1' !!type_sort_value_checked!!/>
			<label for='type_sort_value'>".$msg['intit_gest_tri2']."</label>
		</div>
		<div class='row'>
		...
		<div class='row'>
			...
			<label for='order_sort_asc'>".$msg['intit_gest_tri3']."</label>
			<input type='radio' id='order_sort_desc' name='order_sort' value='1' !!order_sort_desc_checked!!/>
			<label for='order_sort_desc'>".$msg['intit_gest_tri4']."</label>
		</div>
		<div class='row'>
