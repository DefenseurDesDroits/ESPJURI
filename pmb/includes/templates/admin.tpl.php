...
// +-------------------------------------------------+
// $Id: admin.tpl.php,v 1.210.2.6 2016-11-06 19:37:31 Alexandre Exp $
...
<div class='form-contenu'>
	...
	<div class='row'>
		...
		<div class='colonne3'>
			".($opac_serialcirc_active ? "<input type='checkbox' class='checkbox' !!alert_serialcirc_mail!! value='1' name='form_user_alert_serialcircmail' />
...
if ($opac_serialcirc_active) $admin_user_list .= "<tr>
				<td colspan=4 class='brd'>
