...
// +-------------------------------------------------+
// $Id: empr.tpl.php,v 1.159.2.8 2017-05-31 09:31:04 jpermanne Exp $
		...
		<div class='form-empr-fgrp' id='g0'>
			...
			<div class='row' id='g0_r1' etirable='yes' recept='yes' recepttype='circrow' highlight='circrow_highlight' downlight='circrow_downlight' >
				...
				<div class='colonne10' id='g0_r1_f1' movable='yes' title='".$msg[71]."' draggable='yes' dragtype='circcell' recept='yes' recepttype='circcell' highlight='circcell_highlight' downlight='circcell_downlight'>
					...
					<div class='row'>
						<input type='text' class='saisie-5em' id='form_cp' name='form_cp' maxlength='10' value='!!cp!!' onchange=\"openPopUp('./select.php?what=codepostal&caller=empr_form&param1=form_ville&param2=form_cp&deb_rech='+".pmb_escape()."(this.form.form_cp.value), 'select_codepostal', 400, 400, -2, -2, '$select1_prop')\" />
					</div>
				</div>
				<!--   Ville   -->
				<div class='colonne_suite' id='g0_r1_f2' movable='yes' title='".$msg[72]."' draggable='yes' dragtype='circcell' recept='yes' recepttype='circcell' highlight='circcell_highlight' downlight='circcell_downlight'>
					...
					<div class='row'>
						...
						<input type='button'  class='bouton' value='".$msg['parcourir']."' onclick=\"openPopUp('./select.php?what=codepostal&caller=empr_form&param1=form_ville&param2=form_cp&deb_rech='+".pmb_escape()."(this.form.form_cp.value), 'select_codepostal', 400, 400, -2, -2, '$select1_prop')\" />
					</div>
				</div>
				<div class='row'></div>
			</div>
