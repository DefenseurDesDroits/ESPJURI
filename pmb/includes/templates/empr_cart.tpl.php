...
// +-------------------------------------------------+
// $Id: empr_cart.tpl.php,v 1.15.2.5 2016-05-28 13:58:44 jpermanne Exp $
...
<form class='form-$current_module' name='cart_form' method='post' action='!!formulaire_action!!'>
	...
	<div class='form-contenu'>
		...
		<div class='row'>
			<input type='text' class='saisie-80em' id='cart_name' name='cart_name' value='' />
		</div>
		<div class='row'>
			<label class='etiquette' for='cart_comment'>".$msg['caddie_comment']."</label>
		</div>
		<div class='row'>
			<input type='text' class='saisie-80em' id='cart_comment' name='cart_comment' value='' />
		</div>
		<div class='row'>
		...
		<div id='div_acces_rapide' class='row'>
			<label class='etiquette' for='acces_rapide'>".$msg["caddie_fast_access"]."</label>&nbsp;<input type='checkbox' id='acces_rapide' name='acces_rapide' >
		</div>
	</div>
	<!--	boutons	-->
	<div class='row'>
...
<form class='form-$current_module' name='cart_form' method='post' action='!!formulaire_action!!'>
	...
	<div class='form-contenu'>
		...
		<div class='row'>
			<input type='text' class='saisie-80em' id='cart_name' name='cart_name' value='!!name!!' /> <br/>
			!!infos_creation!!
		</div>
		<div class='row'>
			<label class='etiquette' for='cart_comment'>".$msg['caddie_comment']."</label>
...
$empr_cart_action_selector_line = '		
