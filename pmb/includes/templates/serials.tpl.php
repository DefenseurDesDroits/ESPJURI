...
// +-------------------------------------------------+
// $Id: serials.tpl.php,v 1.187.2.11 2017-06-01 08:26:15 jpermanne Exp $
...
<form class='form-$current_module' name='serial_search' method='post' action='./catalog.php?categ=serials&sub=search' onSubmit='return test_form();' >
	...
	<div class='form-contenu'>
		...
		<div class='row'>
			<input id='filter_abo_actif' type='checkbox' name='filter_abo_actif' ".($filter_abo_actif?"checked='checked'":"")." />
		</div>
	</div>
	<div class='row'>
...
<!--    Editeur    -->
	...
	<div id='el2Child_0b' class='row'>
		...
		<input type='button' class='bouton' value='$msg[parcourir]' onclick=\"openPopUp('./select.php?what=editeur&caller=notice&p1=f_ed1_id&p2=f_ed1&p3=dummy&p4=dummy&p5=dummy&p6=dummy&deb_rech='+".pmb_escape()."(this.form.f_ed1.value), 'select_ed1', 400, 400, -2, -2, '$select1_prop')\" />
	...
	<div id='el2Child_7b' class='row'>
		...
		onchange=\"openPopUp('./select.php?what=editeur&caller=notice&p1=f_ed2_id&p2=f_ed2&p3=dummy&p4=dummy&p5=dummy&p6=dummy&deb_rech='+".pmb_escape()."(this.form.f_ed2.value), 'select_ed1', 400, 400, -2, -2, '$select1_prop')\" />
		<input type='button' class='bouton' value='$msg[parcourir]' onclick=\"openPopUp('./select.php?what=editeur&caller=notice&p1=f_ed2_id&p2=f_ed2&p3=dummy&p4=dummy&p5=dummy&p6=dummy&deb_rech='+".pmb_escape()."(this.form.f_ed2.value), 'select_ed1', 400, 400, -2, -2, '$select1_prop')\" />
