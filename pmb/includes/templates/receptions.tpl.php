...
// +-------------------------------------------------+
// $Id: receptions.tpl.php,v 1.5.4.2 2017-06-05 12:55:20 jpermanne Exp $
...
$link_not = "<a href='./catalog.php?categ=isbd&id=!!id_prod!!' target='_blank' ><img border='0' align='middle' src='./images/notice.gif' alt='".htmlentities($msg['acquisition_recept_view_not'],ENT_QUOTES, $charset)."' title='".htmlentities($msg['acquisition_recept_view_not'],ENT_QUOTES, $charset)."' /></a>";

$link_bull = "<a href='./catalog.php?categ=serials&sub=bulletinage&action=view&bul_id=!!id_prod!!' target='_blank' ><img border='0' align='middle' src='./images/notice.gif' alt='".htmlentities($msg['acquisition_recept_view_bull'],ENT_QUOTES, $charset)."' title='".htmlentities($msg['acquisition_recept_view_bull'],ENT_QUOTES, $charset)."' /></a>";

$link_art = "<a href='./catalog.php?categ=serials&sub=bulletinage&action=view&bul_id=!!id_bull!!&art_to_show=!!id_prod!!#anchor_!!id_prod!!' target='_blank' ><img border='0' align='middle' src='./images/notice.gif' alt='".htmlentities($msg['acquisition_recept_view_art'],ENT_QUOTES, $charset)."' title='".htmlentities($msg['acquisition_recept_view_art'],ENT_QUOTES, $charset)."' /></a>";

$link_sug = "<a href='./acquisition.php?categ=sug&action=modif&id_bibli=0&id_sug=!!id_sug!!' target='_blank' ><img border='0' align='middle' src='./images/suggestion.png' alt='".htmlentities($msg['acquisition_recept_view_sug'],ENT_QUOTES, $charset)."' title='".htmlentities($msg['acquisition_recept_view_sug'],ENT_QUOTES, $charset)."' /></a>";
