...
// +-------------------------------------------------+
// $Id: suggestions.tpl.php,v 1.39.4.2 2016-08-26 08:11:44 jpermanne Exp $
...
<input type='button' name='date_inf_lib' class='bouton_small' value='!!date_inf_lib!!' onclick=\"openPopUp('./select.php?what=calendrier&caller='+this.form.name+'&date_caller=&param1=date_inf&param2=date_inf_lib&auto_submit=NO&date_anterieure=YES', 'date_date_suggestion', 250, 300, -2, -2, 'toolbar=no, dependent=yes, resizable=yes');\">
...
<input type='button' name='date_sup_lib' class='bouton_small' value='!!date_sup_lib!!' onclick=\"openPopUp('./select.php?what=calendrier&caller='+this.form.name+'&date_caller=&param1=date_sup&param2=date_sup_lib&auto_submit=NO&date_anterieure=YES', 'date_date_suggestion', 250, 300, -2, -2, 'toolbar=no, dependent=yes, resizable=yes');\">
