...
// +-------------------------------------------------+
// $Id: cms_build.tpl.php,v 1.64.4.11 2016-10-05 09:10:58 dgoron Exp $
...
<tr class='!!odd_even!!' style='cursor: pointer;' onmouseout=\"this.className='!!odd_even!!'\" onmouseover=\"this.className='surbrillance'\"
 	onclick=\"cms_show_obj('!!cadre_object!!_!!id_cadre!!');return false; \" search='!!id_cadre!!_!!cadre_name!!'>
	<td>
...
<tr class='!!odd_even!!' style='cursor: pointer;' onmouseout=\"this.className='!!odd_even!!'\" onmouseover=\"this.className='surbrillance'\"  search='!!id_cadre!!_!!cadre_name!!'>
	<td>
