...
// +-------------------------------------------------+
// $Id: z3950_form.tpl.php,v 1.88.2.5 2017-02-03 11:57:16 jpermanne Exp $
...
<div id='el2Child' class='child' >
	...
	<blockquote>
		...
		<div id='el2Child_0b' class='row'>
		    ...
		    <input type='button' class='bouton' value='".$msg['parcourir']."' onclick=\"openPopUp('./select.php?what=editeur&caller=notice&p1=f_ed1_id&p2=f_ed1&p3=f_coll_existing_id&p4=f_coll_existing&p5=f_subcoll_existing_id&p6=f_subcoll_existing&deb_rech='+".pmb_escape()."(this.form.f_ed1.value), 'select_ed1', 400, 400, -2, -2, '$select1_prop')\" />
	...
	<blockquote>
	    ...
	    <div class='row'>
			...
			<input type='button' class='bouton' value='".$msg['parcourir']."' onclick=\"openPopUp('./select.php?what=subcollection&caller=notice&p1=f_ed1_id&p2=f_ed1&p3=f_coll_existing_id&p4=f_coll_existing&p5=f_subcoll_existing_id&p6=f_subcoll_existing&deb_rech='+".pmb_escape()."(this.form.f_subcoll_existing.value), 'select_subcoll', 400, 400, -2, -2, '$select1_prop')\" />
	...
	<blockquote>
		...
		<div id='el2Child_0b' class='row'>
			<input type='text' completion='publishers' autfield='f_ed11_id' id='f_ed11' name='f_ed11' value=\"!!f_ed11!!\" class='saisie-30emr' />
	   	 	<input type='button' class='bouton' value='".$msg['parcourir']."' onclick=\"openPopUp('./select.php?what=editeur&caller=notice&p1=f_ed11_id&p2=f_ed11&p3=f_coll_id&p4=f_coll&p5=f_subcoll_id&p6=f_subcoll&deb_rech='+".pmb_escape()."(this.form.f_ed11.value), 'select_ed1', 400, 400, -2, -2, '$select1_prop')\" />
