...
// +-------------------------------------------------+
// $Id: catal_form.tpl.php,v 1.133.2.7 2017-02-03 11:57:16 jpermanne Exp $
...
<div id='el2Child_0b' class='row'>
    ...
    <input type='button' class='bouton' value='$msg[parcourir]' onclick=\"openPopUp('./select.php?what=editeur&caller=notice&p1=f_ed1_id&p2=f_ed1&p3=f_coll_id&p4=f_coll&p5=f_subcoll_id&p6=f_subcoll&deb_rech='+".pmb_escape()."(this.form.f_ed1.value), 'select_ed1', 500, 400, -2, -2, '$select1_prop')\" />
...
<div class='row'>
    ...
    <div class='row'>
        ...
        <input type='button' class='bouton' value='$msg[parcourir]' onclick=\"openPopUp('./select.php?what=collection&caller=notice&p1=f_ed1_id&p2=f_ed1&p3=f_coll_id&p4=f_coll&p5=f_subcoll_id&p6=f_subcoll&deb_rech='+".pmb_escape()."(this.form.f_coll.value), 'select_coll', 500, 400, -2, -2, '$select1_prop')\" />
...
<div id='el2Child_3a' class='row'>
    <!--    Sous collection    -->
		...
		<input type='button' class='bouton' value='$msg[parcourir]' onclick=\"openPopUp('./select.php?what=subcollection&caller=notice&p1=f_ed1_id&p2=f_ed1&p3=f_coll_id&p4=f_coll&p5=f_subcoll_id&p6=f_subcoll&deb_rech='+".pmb_escape()."(this.form.f_subcoll.value), 'select_subcoll', 500, 400, -2, -2, '$select1_prop')\" />
...
$ptab[10].= "
	<div id='el10Child_10' title='".htmlentities($msg['notice_usage_libelle'],ENT_QUOTES, $charset)."' movable='yes'>
		<div id='el10Child_10a' class='row'>
		    <label for='f_notice_statut' class='etiquette'>".$msg['notice_usage_libelle']."</label>
		</div>
