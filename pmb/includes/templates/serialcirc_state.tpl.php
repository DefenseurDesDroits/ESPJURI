...
// +-------------------------------------------------+
// $Id: serialcirc_state.tpl.php,v 1.1.2.4 2016-05-10 15:32:17 apetithomme Exp $
...
$serialcirc_state_filters_form = "
	...
	<form class='form-$current_module' name='serialcirc_state_filters' method='post' action='!!form_action!!'>
		<div class='form-contenu'>
			...
			<div class='colonne_suite'>
				...
				<div class='row'>
					...
					<input class='bouton' type='button' onclick=\"openPopUp('./select.php?what=perio&caller=serialcirc_state_filters&param1=serialcirc_state_perio_filter_id&param2=serialcirc_state_perio_filter_label', 'select_perio', 600, 400, -2, -2, 'toolbar=no, dependent=yes,resizable=yes, scrollbars=yes')\" title='".$msg['157']."' value='".$msg['parcourir']."' />
		...
		<div class='row'>
			...
			<div class='right'>
				<img style='cursor:pointer;' src='./images/tableur.gif' onclick='serialcirc_state_export(\"TABLEAU\");' alt='".$msg['caddie_choix_edition_TABLEAU']."' title='".$msg['caddie_choix_edition_TABLEAU']."'/>&nbsp;&nbsp;
				<img style='cursor:pointer;' src='./images/tableur_html.gif' onclick='serialcirc_state_export(\"TABLEAUHTML\");' alt='".$msg['caddie_choix_edition_TABLEAUHTML']."' title='".$msg['caddie_choix_edition_TABLEAUHTML']."'/>&nbsp;&nbsp;
			</div>
		</div>
		<div class='row'></div>
	</form>
