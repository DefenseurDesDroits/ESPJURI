...
// +-------------------------------------------------+
// $Id: titres_uniformes.tpl.php,v 1.12.2.3 2016-06-21 08:13:34 jpermanne Exp $
...
<div class='row'>
	<input type='text' class='saisie-30em' id='form_form' name='tu_form' value='!!tu_form!!'>
</div>	
...
<div id='el1Child_2b_first' class='colonne2'>
	<div class='row'>
		...
		<input type='button' class='bouton' value='$msg[parcourir]' onclick=\"openPopUp('./select.php?what=auteur&caller=saisie_titre_uniforme&param1=f_aut0_id!!iaut!!&param2=f_aut0!!iaut!!&deb_rech='+".pmb_escape()."(this.form.f_aut0!!iaut!!.value), 'select_author2', 500, 400, -2, -2, '$selector_prop')\" />
...
<div  id='el1Child_2b_others' class='colonne_suite'>
	<div class='row'>
		...
		<input type='button' class='bouton' value='$msg[parcourir]' onclick=\"openPopUp('./select.php?what=function&caller=saisie_titre_uniforme&p1=f_f0_code!!iaut!!&p2=f_f0!!iaut!!', 'select_func2', 500, 400, -2, -2, '$selector_prop')\" />
...
<script>
    function fonction_selecteur_auteur() {
        ...
        openPopUp('./select.php?what=auteur&caller=saisie_titre_uniforme&param1='+name_id+'&param2='+name+'&dyn=1&deb_rech='+".pmb_escape()."(document.getElementById(name).value), 'select_author2', 500, 400, -2, -2, '$selector_prop');
    }
    ...
    function fonction_selecteur_fonction() {
        ...
        openPopUp('./select.php?what=function&caller=saisie_titre_uniforme&param1='+name_code+'&param2='+name+'&dyn=1', 'select_fonction2', 500, 400, -2, -2, '$selector_prop');
    }
