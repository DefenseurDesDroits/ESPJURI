...
// +-------------------------------------------------+
// $Id: notice_affichage_ctles.class.php,v 1.11.2.10 2017-06-02 09:45:50 jpermanne Exp $
...
class notice_affichage_ctles extends notice_affichage {
	...
	//Titre
		...
		if ($this->notice->serie_name) {
			$this->notice_public.= "<tr><td align='left' class='bg-grey'><span class='etiq_champ'>".$msg['tparent_start']."</span></td><td class='public_line_value'>".inslink($this->notice->serie_name,  str_replace("!!id!!", $this->notice->tparent_id, $this->lien_rech_serie));;
	...
	//PPN
		foreach ( $this->memo_perso_["FIELDS"] as $i => $value ) {
			...
			if ($p["AFF"] && ($p["NAME"] == "ppn001")){
				$this->notice_public.="<tr><td align='left' class='bg-grey'><span class='etiq_champ'>".strip_tags($p["TITRE"])."</span></td><td class='public_line_value'>".str_replace("Sudoc : ","",$p["AFF"])."</td></tr>";
	...
	//ISSN
		...
		if ($issn) $this->notice_public .= "<tr><td align='left' class='bg-grey'><span class='etiq_champ'>".$msg['code_start']."</span></td><td class='public_line_value'>".htmlentities($issn,ENT_QUOTES, $charset)."</td></tr>";

	//Auteurs
		if ($this->auteurs_tous) $this->notice_public .= "<tr><td align='left' class='bg-grey'><span class='etiq_champ'>".$msg['auteur_start']."</span></td><td class='public_line_value'>".$this->auteurs_tous."</td></tr>";
		if ($this->congres_tous) $this->notice_public .= "<tr><td align='left' class='bg-grey'><span class='etiq_champ'>".$msg['congres_aff_public_libelle']."</span></td><td class='public_line_value'>".$this->congres_tous."</td></tr>";

	//Editeurs
		foreach ( $this->memo_perso_["FIELDS"] as $i => $value ) {
			$p=$this->memo_perso_["FIELDS"][$i];
			if ($p["AFF"] && ($p["NAME"] == "cp_editeurs")){
				$this->notice_public.="<tr><td align='left' class='bg-grey'><span class='etiq_champ'>".strip_tags($p["TITRE"])."</span></td><td class='public_line_value'>".$p["AFF"]."</td></tr>";
				unset($this->memo_perso_["FIELDS"][$i]);
				break;
			}
		}
	...
	// Années de publication
		if ($this->notice->year)
			$this->notice_public .= "<tr><td align='left' class='bg-grey'><span class='etiq_champ'>".($charset != "utf-8"?"Années de publication":utf8_encode("Années de publication"))." :</span></td><td class='public_line_value'>".$this->notice->year."</td></tr>" ;
	...
	// Langues
		if (count($this->langues)) {
			$this->notice_public .= "<tr><td align='left' class='bg-grey'><span class='etiq_champ'>".$msg['537']." :</span></td><td class='public_line_value'>".$this->construit_liste_langues($this->langues);
			...
			$this->notice_public .= "<tr><td align='left' class='bg-grey'><span class='etiq_champ'>".$msg['711']." :</span></td><td class='public_line_value'>".$this->construit_liste_langues($this->languesorg)."</td></tr>";
		}
	...
	// Note générale
		...
		if ($zoneNote) $this->notice_public .= "<tr><td align='left' class='bg-grey'><span class='etiq_champ'>".$msg['n_gen_start']."</span></td><td class='public_line_value'>".$zoneNote."</td></tr>";
	...
	// Catégories
		if ($this->categories_toutes) $this->notice_public .= "<tr><td align='left' class='bg-grey'><span class='etiq_champ'>Sujets :</span></td><td class='public_line_value'>".$this->categories_toutes."</td></tr>";
	...
	function aff_suite() {
		...
		if ($opac_permalink) {
			if($this->notice->niveau_biblio != "b"){
				$ret.= "<tr><td align='left' class='bg-grey'><span class='etiq_champ'>".$msg["notice_permalink"]."</span></td><td class='public_line_value'><a href='".$opac_url_base."index.php?lvl=notice_display&id=".$this->notice_id."'>".substr($opac_url_base."index.php?lvl=notice_display&id=".$this->notice_id,0,80)."</a></td></tr>";
			}else {
				$ret.= "<tr><td align='left' class='bg-grey'><span class='etiq_champ'>".$msg["notice_permalink"]."</span></td><td class='public_line_value'><a href='".$opac_url_base."index.php?lvl=bulletin_display&id=".$this->bulletin_id."'>".substr($opac_url_base."index.php?lvl=bulletin_display&id=".$this->bulletin_id,0,80)."</a></td></tr>";
			}
		}
	...
	//PCP
		...
		if ($result_categ && pmb_mysql_num_rows($result_categ)) {
			$ret_index .= "<tr><td align='left' class='bg-grey'><span class='etiq_champ'>PCP :</span></td><td class='public_line_value'>";
			$first=true;
