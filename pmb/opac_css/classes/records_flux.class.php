...
// +-------------------------------------------------+
// $Id: records_flux.class.php,v 1.1.2.5 2016-10-24 15:55:36 tsamson Exp $
...
// ---------------------------------------------------------------
	...
	private function aff_notices_list($notices_list){
		...
		foreach($notices_list as $notice_id){
			...
			$req = "select notice_id, create_date from notices where notice_id = $notice_id";
			$res = @pmb_mysql_query($req,$dbh);
			if($r=pmb_mysql_fetch_object($res)){
				...
				$desc_explnum=$this->do_explnum($notice->notice_id);
	...
	private function do_explnum($no_notice) {
