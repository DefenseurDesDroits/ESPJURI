...
// +-------------------------------------------------+
// $Id: cms_editorial_types.class.php,v 1.7.4.3 2016-09-22 08:07:02 vtouchard Exp $
...
class cms_editorial_types {
	...
	public function get_type($id){
		$rqt = "select * from cms_editorial_types where editorial_type_element = '".$this->element."' and id_editorial_type = '".($id*1)."'";
		$res = pmb_mysql_query($rqt);
		$type = array();
