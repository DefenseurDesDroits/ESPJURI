...
// +-------------------------------------------------+
// $Id: cms_toolkit.class.php,v 1.1.2.5 2017-04-11 13:06:22 dgoron Exp $
...
class cms_toolkit{
	...
	public function get_title() {
		...
		$title = $this->name. " - ";
		if($this->active) {
			$title .= "<font color='green'>".$msg['cms_toolkit_activated']."</font>";
		} else {
			$title .= "<font color='red'>".$msg['cms_toolkit_disabled']."</font>";
		}
		if($this->name == 'jquery') {
	...
	public function get_form() {
		...
		<div class='row'>
			...
			<input type='radio' id='cms_toolkit_".$this->name."_active_no' name='cms_toolkits[".$this->name."][active]' data-dojo-type='dijit/form/RadioButton' value='0' ".(!$this->active ? "checked='checked'" : "")." />&nbsp;<font color='red'>".$msg['39']."</font>
			<input type='radio' id='cms_toolkit_".$this->name."_active_yes' name='cms_toolkits[".$this->name."][active]' data-dojo-type='dijit/form/RadioButton' value='1' ".($this->active ? "checked='checked'" : "")." />&nbsp;<font color='green'>".$msg['40']."</font>
		</div>
		<div class='row'>&nbsp;</div>";
		if($this->name == 'jquery') {
