...
// +-------------------------------------------------+
// $Id: cms_toolkits.class.php,v 1.1.2.2 2016-10-05 09:10:58 dgoron Exp $
...
class cms_toolkits{
	...
	public static function get_toolkits() {
		...
		$toolkits = array();
		if(file_exists($base_path.'/styles/common/toolkits')) {
			$dh = opendir($base_path.'/styles/common/toolkits');
