...
// +-------------------------------------------------+
// $Id: sort.class.php,v 1.48.2.13 2017-05-15 12:15:08 ngantier Exp $
	...
	static function show_tris_selector() {
		...
		if ($sortArray[0] == 0) {
			...
			switch ($lvl) {
 			...
 			$tris_selector .= "<option value='default'".(($sel_sort == "default") ? " selected" : "").">".$sort->descriptionTriParId("default",false)."</option>";
