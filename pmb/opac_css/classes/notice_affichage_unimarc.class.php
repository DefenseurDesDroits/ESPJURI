...
// +-------------------------------------------------+
// $Id: notice_affichage_unimarc.class.php,v 1.55.2.11 2017-05-16 08:22:20 apetithomme Exp $
...
function do_public($short=0,$ex=1) {
	...
	// constitution de la mention de titre
	if ($this->notice->serie_name) {
		$this->notice_public.= "<tr><td align='right' class='bg-grey'><span class='etiq_champ'>".$msg['tparent_start']."</span></td><td class='public_line_value'>".inslink($this->notice->serie_name,  str_replace("!!id!!","es". $this->notice->tparent_id, $this->lien_rech_serie));;
		if ($this->notice->tnvol)
	...
	$this->notice_public .= "<td class='public_line_value'>".$this->notice->tit1 ;
	...
	// zone de l'editeur
	if ($this->year)
		$annee = "<tr><td align='right' class='bg-grey'><span class='etiq_champ'>".$msg['year_start']."</span></td><td class='public_line_value'>".$this->year."</td></tr>" ;

	if (is_array($this->publishers) && ($this->publishers[0]["name"] || $this->publishers[1]["name"]) ) {
		for ($i=0; $i<count($this->publishers) ;$i++) {
			$this->notice_public.= "<tr><td align='right' class='bg-grey'><span class='etiq_champ'>".$msg['editeur_start']."</span></td><td class='public_line_value'>";
	...
	if(count($this->titres_uniformes)){
		$this->notice_public.= "<tr><td align='right' class='bg-grey'><span class='etiq_champ'>".$msg['titre_uniforme_aff_public']."</span></td><td class='public_line_value'>";
	...
	if($this->notice->coll){
		...
		$this->notice_public .= "<tr><td align='right' class='bg-grey'><span class='etiq_champ'>".$msg['coll_start']."</span></td><td class='public_line_value'>$collection</td></tr>" ;
	}
	if($this->notice->subcoll){
		$subcollection = $this->notice->subcoll->titre.($this->notice->coll->num ? ". ".$this->notice->coll->num :"");
		$this->notice_public .= "<tr><td align='right' class='bg-grey'><span class='etiq_champ'>".$msg['subcoll_start']."</span></td><td class='public_line_value'>$subcollection</td></tr>" ;
	}
	...
	// zone de la collation
	if($this->notice->npages)
		if ($this->notice->niveau_biblio<>"a") $this->notice_public .= "<tr><td align='right' class='bg-grey'><span class='etiq_champ'>".$msg['npages_start']."</span></td><td class='public_line_value'>".$this->notice->npages."</td></tr>";
			else $this->notice_public .= "<tr><td align='right' class='bg-grey'><span class='etiq_champ'>".$msg['npages_start_perio']."</span></td><td class='public_line_value'>".$this->notice->npages."</td></tr>";

	if ($this->notice->ill)
		$this->notice_public .= "<tr><td align='right' class='bg-grey'><span class='etiq_champ'>".$msg['ill_start']."</span></td><td class='public_line_value'>".$this->notice->ill."</td></tr>";
	if ($this->notice->size)
		$this->notice_public .= "<tr><td align='right' class='bg-grey'><span class='etiq_champ'>".$msg['size_start']."</span></td><td class='public_line_value'>".$this->notice->size."</td></tr>";
	if ($this->notice->accomp)
		$this->notice_public .= "<tr><td align='right' class='bg-grey'><span class='etiq_champ'>".$msg['accomp_start']."</span></td><td class='public_line_value'>".$this->notice->accomp."</td></tr>";

	// ISBN ou NO. commercial
	if ($this->notice->code)
		$this->notice_public .= "<tr><td align='right' class='bg-grey'><span class='etiq_champ'>".$msg['code_start']."</span></td><td class='public_line_value'>".$this->notice->code."</td></tr>";

	if ($this->notice->prix)
		$this->notice_public .= "<tr><td align='right' class='bg-grey'><span class='etiq_champ'>".$msg['price_start']."</span></td><td class='public_line_value'>".$this->notice->prix."</td></tr>";
	...
	if (count($this->langues)) {
		...
		$this->notice_public.="</td></tr>";
			...
			if (count($this->languesorg)) $this->notice_public .= "<tr><td align='right' class='bg-grey'><span class='etiq_champ'>".$msg['711']." :</span></td><td class='public_line_value'>".$this->construit_liste_langues($this->languesorg)."</td></tr>";
	...
	if(count($this->notice->notice_pperso)){
		foreach($this->notice->notice_pperso as $pperso){
			...
			if($pperso['value'] && $pperso['libelle'] && $pperso['name'] ){
				...
				switch($pperso['type']){
					case 'url':
						$html_pprerso .= "<tr><td align='right' class='bg-grey'><span class='etiq_champ'>".$pperso['libelle']." :</span></td><td class='public_line_value'><a href='".$pperso['value']."' >".$pperso['value']."</a></td></tr>";
						break;
					default:
						$html_pprerso .= "<tr><td align='right' class='bg-grey'><span class='etiq_champ'>".$pperso['libelle']." :</span></td><td class='public_line_value'>".$pperso['value']."</td></tr>";
						break;
				}
			}
		}
	...
	//Documents numériques
	if ($this->docnums) {
		$this->notice_public .= "<tr><td align='right' class='bg-grey'><span class='etiq_champ'>".$msg['entrepot_notice_docnum']."</span></td><td class='public_line_value'>";
...
function aff_suite() {
	...
	if($this->notice->n_resume)
 		$ret .= "<tr><td align='right' class='bg-grey'><span class='etiq_champ'>".$msg['n_resume_start']."</span></td><td class='public_line_value'>".nl2br(htmlentities(strip_tags(implode("\n",$this->notice->n_resume)),ENT_QUOTES, $charset))."</td></tr>";

	// note de contenu
	if($this->notice->n_contenu)
 		$ret .= "<tr><td align='right' class='bg-grey'><span class='etiq_champ'>".$msg['n_contenu_start']."</span></td><td class='public_line_value'>".nl2br(htmlentities(strip_tags(implode("\n",$this->notice->n_contenu)),ENT_QUOTES, $charset))."</td></tr>";

	// Categories
	if($this->categories_toutes)
		$ret .= "<tr><td align='right' class='bg-grey'><span class='etiq_champ'>".$msg['categories_start']."</span></td><td class='public_line_value'>".$this->categories_toutes."</td></tr>";

	// Concepts
	$concepts_list = new skos_concepts_list();
	if ($concepts_list->set_concepts_from_object(TYPE_NOTICE, $this->notice_id)) {
		$ret .= "<tr><td align='right' class='bg-grey'><span class='etiq_champ'>".$msg['concepts_start']."</span></td><td class='public_line_value'>".skos_view_concepts::get_list_in_notice($concepts_list)."</td></tr>";
	}
	...
	if($mots_cles)
		$ret .= "<tr><td align='right' class='bg-grey'><span class='etiq_champ'>".$libelle_key."</span></td><td class='public_line_value'>".$mots_cles."</td></tr>";


	if(is_array($this->notice->indexint) && count($this->notice->indexint)) {
		$indexint = implode("<br>",$this->notice->indexint);
		$ret.= "<tr><td align='right' class='bg-grey'><span class='etiq_champ'>".$msg['indexint_start']."</span></td><td class='public_line_value'>$indexint</td></tr>" ;
	}
	...
	if ($this->notice->lien) {
		...
		if (substr($this->notice->eformat,0,3)=='RSS') {
			...
			$ret.="<a href=\"".$lien."\" target=\"top\">".htmlentities($this->notice->lien_texte?$this->notice->lien_texte:$this->notice->lien,ENT_QUOTES,$charset)."</a></td></tr>";
		}
		$ret.="</td></tr>";
