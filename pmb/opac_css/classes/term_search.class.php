...
// +-------------------------------------------------+
// $Id: term_search.class.php,v 1.27.4.1 2015-12-23 09:43:59 dgoron Exp $
//
...
class term_search {
    ...
    function page_navigator() {
    	...
    	if ($this->offset!=0) $navig.="<a href=\"$url_page&page=0"."&nbresultterme=".$this->n_total."\"><img src='".get_url_icon('first.gif')."' border='0'/></a>"; else $navig.="<img src='".get_url_icon('first-grey.gif')."' border='0'/>";
		if ($this->offset!=0) $navig.="<a href=\"$url_page&page=".($this->page-1)."&nbresultterme=".$this->n_total."&".$this->base_query."\"><img src='".get_url_icon('prev.gif')."' border='0'/></a>"; else $navig.="<img src='".get_url_icon('prev-grey.gif')."' border='0'/>";
		$navig.=" (".($this->offset+1)."-".min($this->offset+$this->n_per_page,$this->n_total).")/".$this->n_total." ";
		if (($this->offset+$this->n_per_page+1)<$this->n_total) $navig.="<a href=\"$url_page&page=".($this->page+1)."&nbresultterme=".$this->n_total."&".$this->base_query."\"><img src='".get_url_icon('next.gif')."' border='0'/></a>"; else $navig.="<img src='".get_url_icon('next-grey.gif')."' border=0/>";
		if (($this->offset+$this->n_per_page+1)<$this->n_total) $navig.="<a href=\"$url_page&page=$last_page"."&nbresultterme=".$this->n_total."\"><img src='".get_url_icon('last.gif')."' border='0'/></a>"; else $navig.="<img src='".get_url_icon('last-grey.gif')."' border='0'/>";
		return $navig;	
    }
