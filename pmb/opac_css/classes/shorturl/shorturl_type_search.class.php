...
// +-------------------------------------------------+
// $Id: shorturl_type_search.class.php,v 1.2.2.9 2017-04-07 08:12:07 jpermanne Exp $
...
require_once($base_path."/includes/search_queries/specials/permalink/search.class.php");
...
class shorturl_type_search extends shorturl_type{
	...
	protected function permalink()
	{
		...
		$es = new search();
		$html = '
			<html><head></head><body><img src="./images/patience.gif"/>';
		$html.= $es->make_hidden_search_form('index.php?lvl=more_results&mode=extended&search_type_asked=extended_search'.$suite,"form_values","",false);
		if($perso !== null){
			$html.= $perso;
		}
