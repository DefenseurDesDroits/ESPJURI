...
// +-------------------------------------------------+
// $Id: cart_info.php,v 1.64.2.17 2017-05-24 09:16:01 jpermanne Exp $
...
function change_basket_image($id_notice){
	$images_url = array(
		'basket_exist' => get_url_icon('basket_exist.png'),
		'record_in_basket' => get_url_icon('record_in_basket.png')
	);
	print "<script>changeBasketImage(".$id_notice.",".json_encode($images_url).")</script>";
}
...
if ($opac_accessibility && $_SESSION["pmbopac_fontSize"]) {
	print "
