...
// +-------------------------------------------------+
// $Id: subscribe.php,v 1.27.2.9 2017-06-08 08:44:23 jpermanne Exp $
...
if ($time_expired ==1) {
	echo "<script type='text/javascript' >alert(\"".sprintf($msg["session_expired"],round($opac_duration_session_auth/60))."\");</script>";
