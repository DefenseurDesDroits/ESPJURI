...
// +-------------------------------------------------+
// $Id: ajax_liste_lecture.inc.php,v 1.7.4.3 2017-02-01 09:29:30 jpermanne Exp $
...
function delete_empr($id_liste,$id_empr){
	...
	while(($empr=pmb_mysql_fetch_object($res))){
		if($empr->confidential) $display .= "<img border=0 align='top' src='".get_url_icon('cross.png', 1)."'  onclick=\"delete_from_liste('".$id_liste."','".$empr->id_empr."');\">";
		$display .= $empr->nom."<br />";
	}
