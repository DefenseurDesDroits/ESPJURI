...
// +-------------------------------------------------+
// $Id: check_session_time.inc.php,v 1.10.10.1 2017-06-08 08:44:23 jpermanne Exp $
...
if (!$_SESSION["cms_build_activate"]) {
	...
	if ($_SESSION["user_code"]) {
		...
		//Session anonyme
		if (
			$_SESSION["connect_time"] && 
			(substr($_SERVER['HTTP_REFERER'],0,strlen($opac_url_base))==$opac_url_base) && //on vérifie que le referer contient l'opac
