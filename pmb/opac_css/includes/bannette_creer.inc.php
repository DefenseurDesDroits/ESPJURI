...
// +-------------------------------------------------+
// $Id: bannette_creer.inc.php,v 1.26.2.3 2017-02-17 13:24:44 jpermanne Exp $
...
if ($equation) {
	...
	if ($enregistrer=='1') {
		...
		$rqt_bannette.= "    nb_notices_diff=".$dsi_private_bannette_nb_notices.", "; 
