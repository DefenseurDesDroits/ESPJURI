...
// +-------------------------------------------------+
// $Id: show_cart.inc.php,v 1.56.2.8 2017-03-16 13:15:57 dgoron Exp $
...
if (count($cart_)) {
	...
	print 
	'<hr />
		<table border="0" summary="navigation bar" align="center">
			<tr>';

	// affichage des liens 1ere page et page precedente
	if($precedente > 0) {
		print 
		'<td width="14" align="center">
			<a href="./index.php?lvl=show_cart&page=1">
				<img src="'.get_url_icon('first.gif').'" border="0" alt="'.$msg['start'].'" title="'.$msg['first_page'].'" />
			</a>
		</td>
		<td width="14" align="center">
			<a href="./index.php?lvl=show_cart&page='.$precedente.'">
				<img src="'.get_url_icon('prev.gif').'" border="0" alt="'.$msg['prec'].'" title="'.$msg['prec'].'" />
			</a>
		</td>';
	} else {
		print 
		'<td width="14" align="center">
			<img src="'.get_url_icon('first-grey.gif').'" />
		</td>
		<td width="14" align="center">
			<img src="'.get_url_icon('prev-grey.gif').'" />
		</td>';
	}
	print '<td align="center">'.$msg['page'].' '.$page.'/'.$nbepages.'</td>';

	//affichage des liens page suivante et derniere page
	if($suivante<=$nbepages) {
		print 
		'<td width="14" align="center">
			<a href="./index.php?lvl=show_cart&page='.$suivante.'">
					<img src="'.get_url_icon('next.gif').'" border="0" alt="'.$msg['next'].'" title="'.$msg['next'].'" />
			</a>
		</td>
		<td width="14" align="center">
			<a href="./index.php?lvl=show_cart&page='.$nbepages.'">
				<img src="'.get_url_icon('last.gif').'" border="0" alt="'.$msg['end'].'" title="'.$msg['end'].'">
			</a>
		</td>';
	} else {
		print 
		'<td width="14" align="center">
			<img src="'.get_url_icon('next-grey.gif').'" />
		</td>
		<td width="14" align="center">
			<img src="'.get_url_icon('last-grey.gif').'" />
		</td>';
	}
