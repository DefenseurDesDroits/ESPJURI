...
// +-------------------------------------------------+
// $Id: notice_display.inc.php,v 1.80.4.2 2017-04-28 08:41:51 jpermanne Exp $
...
if($id && $acces_v) {
	...
	$requete = "SELECT notice_id, niveau_biblio,typdoc,(opac_visible_bulletinage&0x1) as opac_visible_bulletinage FROM notices WHERE notice_id='$id' LIMIT 1";
	$res = @pmb_mysql_query($requete, $dbh);
			...
			case "s":
				...
				<div id='form_search_bull'>
					<div class='row'></div>\n
						...
						<form name=\"form_values\" action=\"./index.php?lvl=notice_display&id=$id#tab_bulletin\" method=\"post\" onsubmit=\"if (document.getElementById('onglet_isbd$id').className=='isbd_public_active') document.form_values.premier.value='ISBD'; else document.form_values.premier.value='PUBLIC';document.form_values.page.value=1;\">\n
