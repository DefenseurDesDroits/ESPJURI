...
// +-------------------------------------------------+
// $Id: more_results.inc.php,v 1.81.2.5 2016-07-06 10:02:38 dgoron Exp $
...
if (stristr($_SERVER['REQUEST_URI'], ".inc.php")) die("no access");
	...
	//		<img src=\"".get_url_icon("home.gif")."\" border=\"0\" title=\"$msg[back_summmary]\" alt=\"$msg[back_summary]\">$msg[back_summary]</a>"; 
...
*/
	...
	if(trim(str_replace('*','',$user_query)) && $opac_simple_search_suggestions){
		$facettes_tpl .= facettes::make_facette_suggest($user_query);
	}
