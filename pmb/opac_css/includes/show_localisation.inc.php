...
// +-------------------------------------------------+
// $Id: show_localisation.inc.php,v 1.67.2.7 2017-01-02 08:45:36 jpermanne Exp $
...
if (!$location) {
	...
	print "<h3 class='loc_title'><span><a href=\"".$url_section_see."\"><img src='".get_url_icon("home.gif")."' border='0' align='bottom'/></a>$sur_location_link.$location_link</span></h3>";
