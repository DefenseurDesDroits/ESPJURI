...
// +-------------------------------------------------+
// $Id: categ_see.inc.php,v 1.100.2.5 2016-10-04 12:26:50 jpermanne Exp $
...
if ($id) {
	...
	else $thes_lib_to_print = "<a href=\"./index.php?lvl=categ_see&id=".$ourCateg->thes->num_noeud_racine."\"><img src='".get_url_icon("home.gif")."' border='0'></a>";
	
	$context['authority']['breadcrumb'] = '<span class="fil_ariane">'.$thes_lib_to_print.pmb_bidi($ourCateg->categ_path($opac_categories_categ_path_sep,$css)).'</span>';
