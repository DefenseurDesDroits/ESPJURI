...
// +-------------------------------------------------+
// $Id: simple_search.tpl.php,v 1.44.4.2 2017-01-12 15:18:22 ngantier Exp $
...
switch ($search_type) {
	...
	case "simple_search":
		$search_input = "
			...
			<ul class='search_tabs'>
				<li id='current'><a href=\"./index.php?search_type_asked=simple_search\">".$msg["simple_search"]."</a></li>
				!!others!!".
	...
	case "external_search":
		$search_input = "
			<ul class='search_tabs'>
				!!others!!
				<li id='current'><a href='./index.php?search_type_asked=external_search&external_type=simple'>".$msg["connecteurs_external_search"]."</a></li>".
				($opac_show_onglet_help ? "<li><a href=\"./index.php?lvl=infopages&pagesid=$opac_show_onglet_help\">".$msg["search_help"]."</a></li>": '')."
			</ul>
			<div id='search_crl'></div>\n
