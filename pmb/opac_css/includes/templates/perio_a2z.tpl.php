...
// +-------------------------------------------------+
// $Id: perio_a2z.tpl.php,v 1.33.6.3 2016-11-03 15:57:00 vtouchard Exp $
...
<div id='perio_a2z-container'>
	...
	<script type='text/javascript'>
		...
		function show_perio(perio_id) {		
			...
			".($opac_notice_enrichment ? "if( id.children[0] && id.children[0].getAttribute('id')){ getEnrichment(id.children[0].getAttribute('id').replace(/[^0-9]*/ig,''));}" : "")."
			return 1;				
		}		
