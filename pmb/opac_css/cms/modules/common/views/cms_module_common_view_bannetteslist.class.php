...
// +-------------------------------------------------+
// $Id: cms_module_common_view_bannetteslist.class.php,v 1.4.4.3 2016-08-26 10:07:40 dbellamy Exp $
				...
				if ($opac_show_book_pics=='1' && ($opac_book_pics_url || $r->thumbnail_url)) {
					...
					if ($r->thumbnail_url){
						if(strpos($r->thumbnail_url,'data:image',0)===0) {
							...
							$url_vign = $opac_url_base.'getimage.php?url_image='.rawurlencode($r->thumbnail_url);	
						}
