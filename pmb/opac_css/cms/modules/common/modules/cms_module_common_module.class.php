...
// +-------------------------------------------------+
// $Id: cms_module_common_module.class.php,v 1.44.4.5 2016-09-20 15:09:54 vtouchard Exp $
...
class cms_module_common_module extends cms_module_root{
	...
	public function show_cadre(){
 		if($this->get_selected_datasource()){
			if($this->get_selected_view()){
				return "<div id='".$this->get_dom_id()."' class='".$this->class_name." cms_module".($this->css_class != '' ? " ".$this->css_class : "")."'>".$this->selected_view->render($this->selected_datasource->get_datas())."</div>";
			}
 		}
 		return "";
	}
	...
	public function get_human_description(){
		...
		$description .="<span class = 'cms_module_common_datasource_human_description'><em>- ".$this->format_text($this->msg['cms_manage_module_datasources'])."</em> : ".$datasource->get_human_description($this->format_text($this->msg[$datasource->class_name]))."</span><br/>
						<span class = 'cms_module_common_view_human_description'><em>- ".$this->format_text($this->msg['cms_manage_module_views'])."</em> : ".$view->get_human_description($this->format_text($this->msg[$view->class_name]))."</span>";		
		return $description;	
	}
}