...
// +-------------------------------------------------+
// $Id: commandes.inc.php,v 1.81.2.2 2017-02-02 08:36:52 jpermanne Exp $
...
function show_list_cde($id_bibli, $id_exercice = 0) {
	...
	if($nbr_lignes) {
		...
		$url_base = "$PHP_SELF?categ=ach&sub=cmde&action=list&id_bibli=$id_bibli&id_exercice=$id_exercice&user_input=".rawurlencode(stripslashes($user_input))."&statut=$statut&sortBy=$sortBy" ;
...
//TODO A modifier si une seule date de livraison par acte			
			...
			$dn_javascript = "onmousedown=\"document.location='./acquisition.php?categ=ach&sub=cmde&action=modif&id_bibli=".$id_bibli."&id_exercice=".$id_exercice."&id_cde=".$row->id_acte."' \" ";
