...
// +-------------------------------------------------+
// $Id: notice_form.inc.php,v 1.9.10.2 2016-09-13 08:18:54 jpermanne Exp $
...
if($sug->sugg_noti_unimarc){
	...
	if(!$myNotice->id) {
		if($sug->auteur)print "<script type='text/javascript'>openPopUp('./select.php?what=auteur&caller=notice&param1=f_aut0_id&param2=f_aut0&deb_rech=".rawurlencode($sug->auteur)."', 'select_aut1', 400, 400, 0, 0, 'scrollbars=yes, toolbar=no, dependent=yes, resizable=yes');</script>";
		if($sug->editeur)print "<script type='text/javascript'>openPopUp('./select.php?what=editeur&caller=notice&p1=f_ed1_id&p2=f_ed1&p3=f_coll_id&p4=f_coll&p5=f_subcoll_id&p6=f_subcoll&deb_rech=".rawurlencode($sug->editeur)."', 'select_ed1', 400, 400, 30, 30, 'scrollbars=yes, toolbar=no, dependent=yes, resizable=yes');</script>";
	}
}
